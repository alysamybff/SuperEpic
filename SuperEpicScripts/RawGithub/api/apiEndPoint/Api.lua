...
local verify = https://github.com/Stefxtjuh/SuperEpic/blob/main/SuperEpicScripts/RawGithub/Database/premData.lua
local checkverify = verify.GetPlayerByUserId

local ver = 1.4
local plrusername = game.Players.LocalPlayer.Name
local plruserid = game.Players.LocalPlayer.UserId
print("May not work on shit level exploits")
print("Welcome! "..plrusername)
print("Version: ", ver)
print(plruserid.."  Checking verify..")
print(plruserid.."  Verified!..")
print(plruserid.."  Access Granted!..")
